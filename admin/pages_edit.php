	...
	<form name="frmPage" method="post" action="index.php?admin=pages_edit<?php echo ((Application::Get('type') != '') ? '&type='.Application::Get('type'): ''); ?>">
		...
		<tr>
			<td valign="top" style="border:1px solid #dedede">
				...
				<tr>
					<td><?php echo _PAGE_HEADER;?> <span class="mandatory_star">*</span>:</td>
				...
				<tr>
					<td>
						<?php echo _LINK_PARAMETER; ?>: <span class="mandatory_star">*</span>
				...
				<tr id="link_row_1" style="display:none;">
					<td><?php echo _LINK;?> (http://)<span class="mandatory_star">*</span>:</td>
			...
			<td valign="top" style="width:270px;border:1px solid #dedede">
				...
				<tr>
					<td><?php echo _LANGUAGE;?> <span class="mandatory_star">*</span>:</td>
					<td colspan="2">
						<?php
							// display language
