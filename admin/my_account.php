...
?>
	...
	<tr>
		<td width="150px">&nbsp;<?php echo _PREFERRED_LANGUAGE;?> <span class="mandatory_star">*</span>:</td>
		<td>
		<?php
			// display language
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="2" class="main_text">
	<tr>
		<td width="150px">&nbsp;<?php echo _FIRST_NAME;?> <span class="mandatory_star">*</span>:</td>
	...
	<tr>
		<td width="150px">&nbsp;<?php echo _LAST_NAME;?> <span class="mandatory_star">*</span>:</td>
		<td><input class="form_text" name="last_name" type="text" size="25" maxlength="32" value="<?php echo $objAdmin->GetParameter('last_name'); ?>"></td>
	</tr>
	<tr>
		<td width="150px">&nbsp;<?php echo _EMAIL_ADDRESS;?> <span class="mandatory_star">*</span>:</td>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="2" class="main_text">
	<tr>
		<td width="150px">&nbsp;<?php echo _PASSWORD;?> <span class="mandatory_star">*</span>:</td>
		<td width="405px"><input class="form_text" name="password_one" type="password" size="25" maxlength="15"></td>
	</tr>
	<tr>
		<td>&nbsp;<?php echo _RETYPE_PASSWORD;?> <span class="mandatory_star">*</span>:</td>
