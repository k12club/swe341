    ...
    if($tabid == '1_1') {
		...
		$tab_content_2 = '<form name="frmSettings" id="frmSettings" action="index.php?admin=settings" method="post">
			...
			<legend>'._HEADERS_AND_FOOTERS.'</legend>
				...
				<tr valign="top">
					<td width="150px">'._HDR_HEADER_TEXT.' <span class="mandatory_star">*</span>:</td>
			...
			<legend>'._META_TAGS.'</legend>
				...
				<tr valign="top">
					<td width="150px">'._TAG.' &lt;TITLE&gt; <span class="mandatory_star">*</span>:</td>
		...
		$tab_content_4 = '<form id="frmEmailSettings" action="index.php?admin=settings" method="post">
			...
			<tr valign="top">
				...
				<td style="border-left:1px solid #d1d2d3;padding:2px 18px 2px 18px" rowspan="2">
					...
					<tr valign="top">
						<td width="150px">'._EMAIL_ADDRESS.'<span class="mandatory_star">*</span>: <img class="help" src="images/question_mark.png" title="'._ADMIN_EMAIL_ALERT.'" /></td>
						<td align="left">
					...
					<tr valign="top">
						<td width="150px">'._SMTP_HOST.' <span class="mandatory_star">*</span>: <img class="help" src="images/question_mark.png" title="Ex.: smtp.gmail.com" /></td>
						<td align="left"><input type="text" name="smtp_host" id="smtp_host" size="20" maxlength="70" value="'.$params_tab4['smtp_host'].'" /></td>
					</tr>
					<tr valign="top">
						<td width="150px">'._SMTP_PORT.' <span class="mandatory_star">*</span>: <img class="help" src="images/question_mark.png" title="Ex.: 465 or 587" /></td>
						<td align="left"><input type="text" name="smtp_port" id="smtp_port" size="6" maxlength="6" value="'.$params_tab4['smtp_port'].'" /></td>
					</tr>
					<tr valign="top">
						<td width="150px">'._USERNAME.' <span class="mandatory_star">*</span>:</td>
					...
					<tr valign="top">
						<td width="150px">'._PASSWORD.' <span class="mandatory_star">*</span>:</td>
		...
		$tab_content_5 = '<form action="index.php?admin=settings" method="post">
			...
			<table width="99%" border="0" cellspacing="5" cellpadding="5" class="main_text">
			<tr valign="top">
				<td width="90px">'._HDR_TEMPLATE.' <span class="mandatory_star">*</span>:</td>
				<td width="140px">
...
&lt;/Files&gt;
    ...
    $tab3=$tabs->AddTab(_DATETIME_PRICE_SETTINGS, $tab_content_3);        
    ...
    draw_content_start();	
    $tabs->Display();	    
    if(!empty($focus_on_field)) echo '<script type="text/javascript">appSetFocus("'.$focus_on_field.'")</script>';	    
    draw_content_end();
