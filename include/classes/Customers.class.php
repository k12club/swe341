...
/**
 *	Class Customers (for Shopping Cart ONLY)
 *  -------------- 
...
class Customers extends MicroGrid {
	...
	function __construct()
	{
		...
		if(isset($_POST['products_count'])) 	$this->params['products_count'] 	= (int)$_POST['products_count'];
		...
		$this->arrViewModeFields = array(
			...
			'orders_count' => array('title'=>_ORDERS, 'type'=>'label', 'align'=>'center', 'width'=>'90px'),
			'group_name'   => array('title'=>_GROUP, 'type'=>'label', 'align'=>'center', 'width'=>'90px'),
		...
		$this->arrAddModeFields = array(
		    ...
		    'separator_3'   =>array(
				...
				'b_zipcode' 	 => array('title'=>_ZIP_CODE, 'type'=>'textbox', 'width'=>'210px', 'required'=>false, 'maxlength'=>'32', 'validation_type'=>'text'),
				'b_country' 	 => array('title'=>_COUNTRY,	 'type'=>'enum',     'width'=>'210px', 'source'=>$arr_countries, 'required'=>true),
				'b_state' 		 => array('title'=>_STATE,	 'type'=>'textbox', 'width'=>'210px', 'required'=>false, 'maxlength'=>'64', 'validation_type'=>'text'),
			),
		    'separator_4'   =>array(
				'separator_info' => array('legend'=>_ACCOUNT_DETAILS),
				'user_name' 	 => array('title'=>_USERNAME,	 'type'=>'textbox', 'width'=>'210px', 'required'=>true, 'maxlength'=>'32', 'validation_type'=>'text', 'validation_minlength'=>'4', 'readonly'=>false, 'unique'=>true, 'username_generator'=>true),
				'user_password'  => array('title'=>_PASSWORD, 	'type'=>'password', 'width'=>'210px', 'required'=>true, 'maxlength'=>'20', 'validation_type'=>'password', 'cryptography'=>PASSWORDS_ENCRYPTION, 'cryptography_type'=>PASSWORDS_ENCRYPTION_TYPE, 'aes_password'=>PASSWORDS_ENCRYPT_KEY, 'password_generator'=>true),
		    ...
		    'separator_5'   =>array(
				...
				'orders_count'		=> array('title'=>_ORDERS_COUNT,  'type'=>'hidden', 'width'=>'210px', 'required'=>true, 'default'=>'0'),
				'products_count'	=> array('title'=>_PRODUCTS_COUNT,'type'=>'hidden', 'width'=>'210px', 'required'=>true, 'default'=>'0'),
				...
				'comments'			=> array('title'=>_COMMENTS,	  'type'=>'textarea', 'width'=>'420px', 'height'=>'70px', 'required'=>false, 'readonly'=>false, 'validation_type'=>'text', 'maxlength'=>'1024', 'validation_maxlength'=>'1024'),
		...
		$this->arrEditModeFields = array(
		    ...
		    'separator_2'   =>array(
				'separator_info' => array('legend'=>_CONTACT_INFORMATION),
				'email' 		=> array('title'=>_EMAIL_ADDRESS,	 'type'=>'textbox', 'width'=>'230px', 'required'=>true, 'readonly'=>false, 'maxlength'=>'70', 'validation_type'=>'email', 'unique'=>true, 'autocomplete'=>'off'),
				'phone' 		=> array('title'=>_PHONE,	 'type'=>'textbox', 'width'=>'210px', 'required'=>false, 'maxlength'=>'32', 'validation_type'=>'text'),
				'fax' 		    => array('title'=>_FAX,	 'type'=>'textbox', 'width'=>'210px', 'required'=>false, 'maxlength'=>'32', 'validation_type'=>'text'),
			),
		    'separator_3'   =>array(
		    ...
		    'separator_5'   =>array(
				...
				'products_count'	=> array('title'=>_PRODUCTS_COUNT,'type'=>'label'),
	...
	public static function DrawLoginFormBlock($draw = true)
	{
		...
		$output .= '<form class="authentication-form" action="index.php?customer=login" method="post">
			...
			<tr><td><input type="text" style="width:130px" name="user_name" id="user_name" maxlength="32" autocomplete="off" value="'.$username.'" /></td></tr>
