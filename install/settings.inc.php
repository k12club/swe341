...
*/
    ...
    define('EI_PASSWORD_ENCRYPTION_KEY', 'apphp_shopping_cart');
    ...
    // -------------------------------------------------------------------------
    // *** application name
    define('EI_APPLICATION_NAME', 'ApPHP Shopping Cart Pro');
    define('EI_APPLICATION_VERSION', '3.8.4');
    ...
    define('EI_POST_TEXT', '<br />Please check access permissions to
        <ul>
            ...
            <li>images/manufacturers/</li>
            <li>images/products/</li>
            <li>tmp/backup/</li>
            <li>tmp/export/</li>
            <li>tmp/cache/</li>
            <li>tmp/logs/</li>            
