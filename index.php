...
## --------------------------------------------------------------------------- #
##  ApPHP Shopping Cart Pro version 3.8.4                                      #
##  Developed by:  ApPHP <info@apphp.com>                                      #
##  License:       GNU LGPL v.3                                                #
##  Site:          http://www.apphp.com/php-shopping-cart/                     #
##  Copyright:     ApPHP Shopping Cart (c) 2010-2011. All rights reserved.     #
##                                                                             #
...
##  -- FPDF v1.6 (PDF files generator)                     http://www.fpdf.org #
##                                                                             # 
################################################################################
...
// *** get site content
// -----------------------------------------------------------------------------
if(!preg_match('/order_notify_/i', Application::Get('page'))){	
	$cachefile = '';
	if($objSettings->GetParameter('caching_allowed') && !$objLogin->IsLoggedIn()){
		...
		$c_manufacturer_id = Application::Get('manufacturer_id');
		$c_product_id  = Application::Get('product_id');
		
		if(($c_page == '' && $c_customer == '' && $c_admin == '') || 
		   ($c_page == 'pages' && $c_page_id != '') ||
		   ($c_page == 'category' && $c_category_id != '') ||
		   ($c_page == 'product' && $c_product_id != '') ||
		   ($c_page == 'manufacturer' && $c_manufacturer_id != '') || 
...
echo "\n<!-- This page was generated by ApPHP Shopping Cart v".CURRENT_VERSION." (http://www.apphp.com/php-shopping-cart/) -->";
?>