...
?>
	<form action="index.php?customer=login" method="post">
		...
		<tr>
			...
			<td width="88%"><input type="text" name="user_name" id="txt_user_name" class="form_login" maxlength="50" autocomplete="off" /></td>
		</tr>
		<tr>
			<td><?php echo _PASSWORD;?></td>
			<td><input type="password" name="password" class="form_password" maxlength="20" autocomplete="off" /></td>
		</tr>
