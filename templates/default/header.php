...
<div id="topMenuBar">
  ...
  <tbody>
  <tr>
    <td width="34px"><img width="34px" height="41px" alt="" src="<?php echo APPHP_BASE;?>templates/default/images/cor-start-<?php echo Application::Get('lang_dir');?>.gif" /></td>
	...
	<td width="9px"><img width="9px" height="41" alt="" src="<?php echo APPHP_BASE;?>templates/default/images/cor-end-<?php echo Application::Get('lang_dir');?>.gif" /></td>
	</tr>
	</tbody>
	</table>
</div>
	...
	<div class="nav_language <?php echo 'float_'.Application::Get('defined_left'); ?>">
		<?php				
			...
			if($objLang->GetLanguagesCount('front-end') > 1){
				echo '<div style="padding-top:3px;margin-right:6px;float:left;">'._LANGUAGES.'</div>';
